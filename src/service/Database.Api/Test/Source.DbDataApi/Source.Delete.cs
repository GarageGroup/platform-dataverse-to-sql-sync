            ...
            [
                ...
                new DbDeleteQuery(
                    ...
                    filter: new DbCombinedFilter(DbLogicalOperator.And)
                    {
                        ...
                        {
                            new("CrmId", DbFilterOperator.Equal, Guid.Parse("6f410eaa-e6b7-4bf7-9b3a-81b67276ec4b")),
                            new("SyncTime", DbFilterOperator.Less, new DateTimeOffset(2017, 10, 21, 15, 45, 01, default))
                        }
                    })
                {
                    TimeoutInSeconds = 300
